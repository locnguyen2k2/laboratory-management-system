...
export class AuthService {
    ...
    async resetPassword(email: string): Promise<any> {
        ...
        try {
            ...
            throw new HttpException({ message: "The new digital numbers was send to your Email!", status: 200 }, HttpStatus.ACCEPTED).getResponse()
        }
    }
        ...
        try {
            ...
            if (data.digitalNumbs === decoded.digitalNumbs) {
                ...
                if (!isCheckPass) {
                    ...
                    throw new HttpException({ message: 'Your password is updated!', status: 200 }, HttpStatus.ACCEPTED).getResponse();
                }
